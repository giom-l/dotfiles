# Generated by Powerlevel10k configuration wizard on 2020-01-03 at 08:43 CET.
...
# angled separators, sharp heads, blurred tails, 2 lines, dotted, left frame, darkest,
...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      ...
      '*dev*'  	DEV    
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_AWS_PROD_BACKGROUND='darkred'
  typeset -g POWERLEVEL9K_AWS_DEV_BACKGROUND='darkgreen'
  typeset -g POWERLEVEL9K_AWS_DEFAULT_BACKGROUND='grey15'
  ...
  # Add specific behaviour to display Gcloud prompt only when GCLOUD_ON var is set
  typeset -g POWERLEVEL9K_GCLOUD_CONTENT_EXPANSION='${GCLOUD_ON+$P9K_CONTENT}'
  typeset -g POWERLEVEL9K_GCLOUD_VISUAL_IDENTIFIER_EXPANSION='${GCLOUD_ON+$P9K_VISUAL_IDENTIFIER}'
  ...
  # Add KUBE_ON to display only when KUBE_ON env var is set
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${KUBE_ON+${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_NAME}}}'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_VISUAL_IDENTIFIER_EXPANSION='${KUBE_ON+$P9K_VISUAL_IDENTIFIER}'
