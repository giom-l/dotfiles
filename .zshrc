...
if zplug check "bhilburn/powerlevel9k"; then
    ...
    P9K_PROMPT_ADD_NEWLINE_COUNT=2
...
#
# Automatically source aws-zsh-completer
source ~/.local/bin/aws_zsh_completer.sh

#Add aws binaries and jetbrain toolbox in path
export PATH=$PATH:~/.local/bin/

# Load various env files
for file in ~/.{aliases,aliases_krg,functions}; do
...
#	"${fpath[@]}" 
#)
fpath=($fpath $HOME/scripts/completions)
# reload compinit to handle completion properly
autoload -Uz compinit && compinit -u

# The next line updates PATH for the Google Cloud SDK.
if [ -f '/home/gocho/.local/google-cloud-sdk/path.zsh.inc' ]; then . '/home/gocho/.local/google-cloud-sdk/path.zsh.inc'; fi

# The next line enables shell command completion for gcloud.
if [ -f '/home/gocho/.local/google-cloud-sdk/completion.zsh.inc' ]; then . '/home/gocho/.local/google-cloud-sdk/completion.zsh.inc'; fi
